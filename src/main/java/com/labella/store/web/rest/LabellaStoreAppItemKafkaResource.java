...
@RestController
@RequestMapping("/api/labella-store-app-item-kafka")
public class LabellaStoreAppItemKafkaResource {
    private final Logger log = LoggerFactory.getLogger(LabellaStoreAppItemKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public LabellaStoreAppItemKafkaResource(KafkaProperties kafkaProperties) {
